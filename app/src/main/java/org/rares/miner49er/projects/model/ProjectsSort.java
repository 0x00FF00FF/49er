...
public class ProjectsSort {
    ...
    private static final String TAG = ProjectsSort.class.getSimpleName();
     ...
     */
    public List<ProjectData> sort(List<ProjectData> list, int sortType) {
    ...
    public List<ProjectData> sort (List<ProjectData> list) {
        ArrayList<ProjectData> sortedArray = new ArrayList<>(list);
        Collections.sort(sortedArray, comparator);
        return sortedArray;
    }


    private Comparator<ProjectData> simpleComparator = new Comparator<ProjectData>() {
        @Override
    ...
    private Comparator<ProjectData> alphaNumComparator = new Comparator<ProjectData>() {
        @Override
        public int compare(ProjectData o1, ProjectData o2) {
    ...
    @Setter
    private Comparator<ProjectData> comparator = alphaNumComparator;
