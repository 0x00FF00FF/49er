...
//    private long id;
  ...
  UserData owner;
  /* final*/ List<UserData> team = new ArrayList<>();    // todo concurrent modification
  /* final*/ List<IssueData> issues = new ArrayList<>();
...
//        Log.i(TAG, "compareContents: " + this.toString() + " | " + otherData.toString());
  ...
  private ProjectData deepClone() {
    ...
    if (this.issues != null) {
      ...
      for (IssueData id : this.issues) {                  // todo concurrent modification
